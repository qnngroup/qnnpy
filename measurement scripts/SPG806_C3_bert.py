...
for j in range(0,10000):
    ...
    if byte_meas != byte_list[i]:
        ...
        data_dict = {'channel_voltage':channel_voltage, 'enable_voltage':enable_voltage, 'trace_chan':data1, 'trace_enab':data2, 'bit_string':byte_list[i], 'byte_meas':byte_meas}
        file_path = qf.save(b.properties,'nMem_bert_test_prbs2', data_dict)    
        plt.savefig(file_path+".png")
        b.inst.scope.save_screenshot(file_path+'screen_shot'+'.png', white_background=False)
