...
filedirectry = r'C:\Users\ICE\Desktop\Di Zhu ICE Oxford\data\LC11\20190404_LC11_3rd_cooldown'
sample_name = 'LC11'
device_name = 'HFB'
...
file_path, file_name  = save_data_dict(data_dict, test_type = test_type, test_name = sample_name+'_'+device_name+comments,
...
for i in range(len(S21)):
    plt.plot(f/1e9, 20*np.log10(np.abs(S21[i])-VNA_att[i]), label = 'P = {}dBm'.format(pna_power[i]))
plt.legend()
