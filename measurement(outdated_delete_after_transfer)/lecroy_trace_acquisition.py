...
fpath = r'C:\Users\ICE\Desktop\Di Zhu ICE Oxford\data\AQ\SPF831_PNR_v3\\'

#%%
fname = 'SPF831_PNR_v3_100Hz_ref_3Vpp'
save_traces(channels = ['C2','C3', 'F1','F2','F3','F4'], fname = fname, fpath = fpath)
lecroy.set_trigger_mode('Stop')

#%%
#save pulse shapes
fname ='SPF831_PNR_v3_ref'
save_traces_multiple(channels = ['C1','C2','F1'], num_traces = 10, threshold = [0], fpath=fpath, fname=fname)
