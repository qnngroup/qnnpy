...
class Keithley2001(object):
    ...
    def set_voltage_rate(self, nplcs=1): #specify read speed in terms of NPLCs. 1 PLC = 1/60th of a second
        self.write(':VOLT:NPLC %0.1e' % nplcs)
        
    def set_current_rate(self, nplcs=1): #specify read speed in terms of NPLCs. 1 PLC = 1/60th of a second
