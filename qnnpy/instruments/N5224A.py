...
class N5224A(object):
    ...
    def freq_range(self, f_start = 0.1e9, f_stop = 1.0e9, f_center = None, f_span = None, num_pts = 401):
    ...
    def run_sweep_ri(self):
        ...
        completion = self.query('OPC?;SING;') # Runs a SINGle sweep, and waits for the OPeration to Complete
        self.timeout = temp
