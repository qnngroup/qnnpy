...
class SantecTSL(SantecTSLBase):
    ...
    def initialize(self):
        ...
        print('min wavelength: {} nm, max wavelength: {} nm'.format(self.wav_min, self.wav_max))
    ...
    def setSweepCycles(self, numOfSweeps):
        self.rsc.write(':WAVelength:SWEep:CYCLes ' + str(numOfSweeps))  # if Range 0~999. 0 means infinite sweep
        if numOfSweeps == 0:
            self.rsc.write(':WAV:SWE:REP')  # continuously repeat the sweeps
