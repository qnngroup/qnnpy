...
class AQ6370(object):
    ...
    def set_resolution(self, resolution = .02e-9):
        '''set resolution in nm, choices
        .02 nm, .1 nm, .2 nm, .5 nm, 1.0 nm, 2.0 nm'''
        if resolution not in [.02e-9, .1e-9, .2e-9, .5e-9, 1.0e-9, 2,0e-9]:
    ...
    def quick_setup(self, wl_center = 1550e-9, wl_span = 2e-9, resolution = .02e-9, 
                    average = 1):
