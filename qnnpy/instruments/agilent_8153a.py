...
class Agilent8153A(object):
    ...
    def setup_basic(self, lambda_nm = 1550, averaging_time = 0.1):
        ...
        self.set_averaging_time(averaging_time = averaging_time) # Sets averaging time, 20ms < value < 3600s
        self.set_wavelength(lambda_nm = lambda_nm)
        # self.write('OUTP 1')

    def set_averaging_time(self, averaging_time = 0.1):
        self.write('SENS1:POW:ATIME %0.3e' % averaging_time) # Sets averaging time, 20ms < value < 3600s
