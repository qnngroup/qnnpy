...
class KeysightDSOX(object):
    ...
    def get_preamble(self):
        ...
        wav_form, acq_type, wfmpts, avgcnt, x_increment, x_origin, x_reference, y_increment, y_origin, y_reference = np.array(val.split(','), dtype=np.float32)
        return wav_form, acq_type, wfmpts, avgcnt, x_increment, x_origin, x_reference, y_increment, y_origin, y_reference
